// ponytail: lucide-react v1 dropped brand icons, so hand-roll the GitHub mark.
// Mirrors the lucide API (size/style/color) so callers stay unchanged.
export function Github({ size = 24, style, color = 'currentColor' }: { size?: number; style?: React.CSSProperties; color?: string }) {
  return (
